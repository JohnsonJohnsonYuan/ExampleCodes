...
namespace DotNet.Framework.Common
{
    ...
    public class ChartHelper
    {
        ...
        public void Create(Chart chart, string title, List<Excel.DataTable> tables, List<DateTime> dates, string xColumn, string yColumn, string style, bool user3D, string targetUrl)
        {
            chart.Palette = new Color[] { Color.FromArgb(49, 255, 49), Color.FromArgb(255, 255, 0), Color.FromArgb(255, 99, 49), Color.FromArgb(0, 156, 255),
            Color.FromArgb(255, 125, 49), Color.FromArgb(125, 255, 49), Color.FromArgb(0, 255, 49) };
            chart.Use3D = user3D;
